...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-3 w-auto mx-auto", className)}
      classNames={{
        ...
        day: cn(
          ...
          "h-8 w-8 sm:h-9 sm:w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground"
        ),
