...
const Client_11 = require("./api/resources/projects/client/Client");
const Client_12 = require("./api/resources/chapters/client/Client");
...
class ElevenLabsClient {
    ...
    get projects() {
        var _a;
        return ((_a = this._projects) !== null && _a !== void 0 ? _a : (this._projects = new Client_11.Projects(this._options)));
    }
    get chapters() {
        var _a;
        return ((_a = this._chapters) !== null && _a !== void 0 ? _a : (this._chapters = new Client_12.Chapters(this._options)));
    }
    get dubbing() {
        var _a;
